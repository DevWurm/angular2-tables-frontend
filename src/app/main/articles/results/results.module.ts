...
import {ResultsListPrimengModule} from "./results-list-primeng/results-list-primeng.module";
...
@NgModule({
  imports: [ CommonModule, ResultsListVaadinGridModule, ResultsListPrimengModule],
